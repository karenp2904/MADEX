...
export function ProductCard({
  ...
  return (
    <Card
      className="w-[226px] h-[308px] hover:cursor-pointer hover:shadow-2xl overflow-hidden flex shadow-xl rounded-3xl"
      onClick={() => navigate(Router.detalle + `?producto=${product.id_producto}`)}  
    >
      <CardHeader
        floated={false}
        shadow={false}
